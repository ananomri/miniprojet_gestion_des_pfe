...
public class Main {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBackground(new Color(72, 119, 183));
		...
		lblNewLabel_3.setBounds(148, 50, 77, 21);
		panel_1.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\Anen\\Downloads\\Users-Administrator-icon (1).png"));
		lblNewLabel_4.setBounds(20, 10, 129, 126);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				login_admin logad=new login_admin();
				logad.firstframe.setVisible(true);
				frame.dispose();
			}
		});
		...
		JLabel lblNewLabel_7 = new JLabel("Espace Enseignant");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				login_enseignant logens=new login_enseignant();
				logens.Secondframe.setVisible(true);
				frame.dispose();
				}
		});
		...
		JLabel lblNewLabel_11 = new JLabel("Espace Etudiant");
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				login_etudiant logetud=new login_etudiant();
				logetud.thirdframe.setVisible(true);
				frame.dispose();
			}
		});
